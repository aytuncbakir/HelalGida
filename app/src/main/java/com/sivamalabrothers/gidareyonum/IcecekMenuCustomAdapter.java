...
public class IcecekMenuCustomAdapter extends RecyclerView.Adapter<IcecekMenuCustomAdapter.MyViewHolder> {


    ArrayList<IcecekMenuItem> mDataList;
    LayoutInflater inflater;
    int pos;
    Context context;

    public IcecekMenuCustomAdapter(Context context, ArrayList<IcecekMenuItem> data){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        IcecekMenuItem tiklananItem = mDataList.get(position);
    ...
    public void tiklananMenuCagir(int pos){
        IcecekSayfasi girisSayfasi;
        girisSayfasi = (IcecekSayfasi) context;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setData(IcecekMenuItem tiklananItem, int position) {
